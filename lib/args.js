...
program.option("-l, --catalogue <string>", "章节列表选择器。", "#list a");
program.option("-c, --content <string>", "章节列表选择器。", "#content");
program.option("-l, --limit <number>", "并发请求数量。", parse, 5);
program.option("-s, --sleep <number>", "每个请求的间隔时间。", parse, 0);
program.option("-m, --min-length <number>", "正文最小长度（小于这个长度将会被认为是作者的废话从而丢弃掉）。", parse, 1000);
